      ...
      <div onClick={() => setOpen(o => !o)}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.6rem', color: 'var(--warm-grey)', marginTop: '0.1rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <span style={{ color: 'var(--warm-grey)', fontSize: '0.75rem', transform: open ? 'rotate(90deg)' : 'none', display: 'inline-block', transition: 'transform 0.2s' }}>›</span>
        </div>
      </div>
      {open && (
...
export default function Dashboard({ showToast, user, profile }) {
  ...
  // Get name and wedding date from profile OR user metadata as fallback
  ...
  return (
    <div className="screen-content fade-up">
      ...
      <div style={{ background: 'var(--navy)', padding: '1.5rem 1.25rem 2rem', position: 'relative', overflow: 'hidden' }}>
        <div style={{ fontSize: '0.68rem', fontWeight: 400, letterSpacing: '0.15em', color: 'rgba(250,247,242,0.4)', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Good day</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', background: 'rgba(250,247,242,0.05)', borderRadius: 'var(--radius)', padding: '1.25rem' }}>
          ...
          <div>
            ...
            {!weddingDate && <div style={{ fontSize: '0.78rem', fontWeight: 300, color: 'rgba(250,247,242,0.4)', marginTop: '0.2rem' }}>Set your wedding date in Profile</div>}
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: '0 1.25rem' }}>
        ...
        {loadingTasks ? (
          ...
          <div style={{ textAlign: 'center', padding: '2rem', color: 'var(--warm-grey)', fontSize: '0.88rem' }}>
            <p>No tasks yet. Sign out and sign back in to load your planning tasks.</p>
          </div>
        ) : (
          phases.map(phase => (
